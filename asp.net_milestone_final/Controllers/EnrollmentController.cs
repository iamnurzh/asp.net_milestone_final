...
using asp.net_milestone_final.Data;
using asp.net_milestone_final.Models;

namespace asp.net_milestone_final.Controllers
{
    public class EnrollmentController : Controller
    {
        private readonly aspnet_milestone_finalContext _context;

        public EnrollmentController(aspnet_milestone_finalContext context)
        {
            _context = context;
        }
        ...
        {
            var aspnet_milestone_finalContext = _context.Enrollment.Include(e => e.Course).Include(e => e.Student);
            return View(await aspnet_milestone_finalContext.ToListAsync());
        }
